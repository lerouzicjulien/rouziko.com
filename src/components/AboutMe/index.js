      ...
      <div className="part">
        <div className="part-one">
          ...
          <div className="part-one-words">
            ...
            {/* <div className="part-one-words-single"> Adaptabilité /</div>
            <div className="part-one-words-single"> Curiosité /</div>
            <div className="part-one-words-single"> Résolution de problèmes /</div>
            <div className="part-one-words-single"> Esprit d'équipe /</div>
            <div className="part-one-words-single"> Transmission</div> */}
          </div>
        ...
        <div className="part-two-cv">
          ...
          <a href={cv}><img className="part-two-cv-image" src={cv} alt="cv" /></a>
        </div>
      </div>
    </div>
  );
